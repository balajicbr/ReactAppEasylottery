...
import './MyWinsClaimPrizeFinishedUpload.css';

const MyWinsClaimPrizeFinishedUpload = () => {
  ...
  return (
    <div className="claim-prize-finished-upload-container">
...
export default MyWinsClaimPrizeFinishedUpload;
