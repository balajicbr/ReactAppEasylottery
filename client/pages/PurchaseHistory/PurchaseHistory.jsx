              ...
              >
                ...
                <div className="ticket-details">
                  <div className="ticket-header">
                    ...
                    <span className="right-ticket-text">Total tickets: {ticket.totalTickets}</span>
                    <span className="right-ticket-text">Prize Money: {ticket.prizez}</span>
                    <span className="right-ticket-text">Price: {ticket.total_amount}</span>
                ...
                {ticketsDetails.map((ticket, index) => (
                  ...
                  <NavLink
                    ...
                    onClick={() => { 
                      ...
                      localStorage.setItem("type", "purchase");
                  ...
                  >
                    ...
                    <div className="ticket-detail-row">
                      ...
                      <div className="status-badge" style={{ marginTop: "15px", color: "#FFFF", height: "30px", }}>
